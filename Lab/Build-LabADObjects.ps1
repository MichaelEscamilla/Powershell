        ...
        try {
            ...
            foreach ($group in $groups) {
                ...
                if ($existingGroup) {
                    ...
                    New-ADGroup -Name $groupName -SamAccountName $groupName -DisplayName $groupName -GroupCategory Security -GroupScope Global -Path $OUName -Description $groupDescription -ErrorAction Stop
